  ...
  SlipHover.prototype = {
    init: function () {
      ...
      $(this.element)
        ...
        .on("mouseenter.sliphover", target, function (event) {
          ...
          $overlayContainer
            .off("mouseenter.sliphover mouseleave.sliphover")
            .on("mouseenter.sliphover mouseleave.sliphover", function (event) {
              //if (!$overlayContainer) return;
              var direction = that.getDirection($(this), event);

              //check if reverse option is on
              direction = that.settings.reverse
    ...
    createOverlay: function (instance, direction, $element) {
      ...
      $overlayColor = instance.settings.backgroundColorAttr
        ...
        : instance.settings.backgroundColor;
    ...
    removeOverlay: function (instance, $overlayContainer, direction) {
      ...
      $overlay
        .stop()
        .animate(finalState, instance.settings.duration, function () {
